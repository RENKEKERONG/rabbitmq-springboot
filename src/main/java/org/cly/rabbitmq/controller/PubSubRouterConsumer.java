...
//@RabbitListener(queuesToDeclare = @Queue(value = "pubsubEx", durable = "false", autoDelete = "false"))
@RabbitListener(queues = "pubsub.ex")
public class PubSubRouterConsumer {
    @RabbitHandler
    public void getMessage(String message) {
        System.out.println("pubsub开始消费：" + message);
